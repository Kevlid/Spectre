...
export const MessageCreate: Event = {
	...
	async execute(client: KiwiClient, message: Message) {
		...
		var totalMessages = existingRecord
			? existingRecord.totalMessages + 1
			: 1;
		var dailyMessages = existingRecord
			? existingRecord.dailyMessages + 1
			: 1;
		var weeklyMessages = existingRecord
			? existingRecord.weeklyMessages + 1
			: 1;
		var monthlyMessages = existingRecord
			? existingRecord.monthlyMessages + 1
			: 1;
