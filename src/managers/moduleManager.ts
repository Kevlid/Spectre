...
export class ModuleManager {
    ...
    load(module: Module) {
        ...
        if (module.messgaeCommands) {
            for (let messageCommand of module.messgaeCommands) {
                messageCommand.module = module;
                this.client.CommandManager.loadMessage(messageCommand);
            }
        }
    ...
    async registerCommands(commands: any[], guildId?: string) {
        ...
        this.client.CommandManager.registerMany(cmds, guildId);
    }
}
